...
def fpn_train(train_data=None,
              img_name_batch=None,
              gtboxes_and_label_batch=None,
              num_objects_batch=None,
              default_gragh=None):

    with default_gragh.as_default():
        with tf.name_scope('draw_gtboxes'):
...
if __name__ == '__main__':
    ...
    # with g.as_default():
    #     with tf.name_scope('get_batch'):
    #         img_name_batch, train_data, gtboxes_and_label_batch, num_objects_batch = \
    #             next_batch(dataset_name=cfgs.DATASET_NAME,
    #                        batch_size=cfgs.BATCH_SIZE,
    #                        shortside_len=cfgs.SHORT_SIDE_LEN,
    #                        is_training=True)
    #
    # fpn_train(train_data=train_data,
