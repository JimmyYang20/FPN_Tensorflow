...
def fpn_inference(imgs=None, checkpoint_path=None, img_names=None):
  with tf.Graph().as_default():
...
if __name__ == "__main__":
  ...
  # print(args)
  # inference(args)
  image_dir = cfgs.INFERENCE_IMAGE_PATH
  checkpoint_path = tf.train.latest_checkpoint(
      os.path.join('../output/{}'.format(cfgs.DATASET_NAME), FLAGS.trained_checkpoint, cfgs.VERSION))
  fpn_inference(checkpoint_path=checkpoint_path, image_path=image_dir)
